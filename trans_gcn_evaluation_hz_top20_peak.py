...
from trans_utils import read_cfg_file, get_log_dir, get_logger, load_graph_data_adj_mx, load_graph_data
...
hztop20_index = np.array(
    [2, 53, 55, 46, 24, 5, 14, 13, 16, 22, 33, 8, 12, 20, 11, 10, 4, 7, 9, 15])
